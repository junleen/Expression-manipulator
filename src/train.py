...
from data.dataset import CustomDatasetDataLoader
    ...
    def _train_epoch(self, i_epoch):
        ...
        for i_train_batch, train_batch in enumerate(self._dataset_train):
            ...
            train_generator = ((i_train_batch + 1) % self._opt.train_G_every_n_iterations == 0) \
                              or do_visuals or i_epoch <= self._opt.nepochs_warm_up
            ...
            # save model
            if (self._last_save_latest_time is None \
                or time.time() - self._last_save_latest_time > self._opt.save_latest_freq_s)\
                and i_epoch % self._opt.save_every_epoch == 0:
